...
function displayPics(){
  ...
  // Rando now throws an error because let is block-scoped, and using it means that rando is declared only within while loop, instead of being accessible within the entire function displayPics().
  console.log(viewed);
