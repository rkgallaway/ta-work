...
// This is undefined, because the new function defines its own this value, and it does not have its own, so it has nothing to refer to.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The base object, because it does not have its own this, so it looks to the enclosing scope, which is the window, in this case.
// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions do not have their own this. Arrow functions are not designed to be used with this. 
