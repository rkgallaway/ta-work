...
Write a function called sumArray() that takes in an array of numbers as its single argument and then returns an array where the
 first element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication, use your multiply() function that
 you've already created. You're going to have to be resourceful to figure out how to do this. This function should handle an array
  containing three elements. However, you may continue to use the + operator for string concatenation.
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var result = [];
    var firstSum = multiply(multiply(dynamicArray[0], dynamicArray[1])[0], dynamicArray[2])[0];
    var secSum = multiply(dynamicArray[3], dynamicArray[4])[0];
    var finalSum = multiply(firstSum, secSum)[0];
    result[0] = finalSum;
    result[1] = `The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${result[0]}.`
    return result;
}
