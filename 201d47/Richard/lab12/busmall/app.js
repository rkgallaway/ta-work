...
// Ryan - possibly do a container event listener also
var imgId1 = "img1";
var imgId2 = "img2";
var imgId3 = "img3";
...
function renderThreeRandomImages(event){
    ...
    if(event) { //click counter
        ...
        if(totalClicks === MAX_CLICKS) {
            // Ryan-remove event listener for container here.
...
// - Ryan constuctor always begins with a capital letter
